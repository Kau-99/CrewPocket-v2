...
export const es: Dictionary = {
  ...
  jobs: {
    ...
    summary: {
      ...
      laborNote: "Los costos de mano de obra llegan con el control de horas (Fase 3).",
    },
    tabs: {
      overview: "Resumen",
      time: "Horas",
    ...
    comingSoonTime: "El control de horas llega en la Fase 3.",
    comingSoonPhotos: "Las fotos llegan en la Fase 3.",
  },
  errors: {
